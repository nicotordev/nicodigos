...
import { categoryFiltersToQueryString } from "@/lib/store/category/url";
import type { CategoryProductsFilters } from "@/lib/store/category/types";
import { cn } from "@/lib/utils";

type CategoryPaginationClientProps = {
  basePath: string;
...
export function CategoryPaginationClient({
  ...
  const hrefForPage = (targetPage: number) =>
    `${basePath}${categoryFiltersToQueryString({ ...filters, page: targetPage })}`;
